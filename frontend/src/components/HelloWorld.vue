<template>
  <div class="hello">
    ...
    <div v-if=db_bool>
        <h2 class="center-align">Neues Produkt einfügen</h2>
        <form @submit.prevent="register" >
        <div class="row">
            <div class="input-field">
                <label class="active" >Produkt </label>
                <input id="name" placeholder="Produkt Name" type="text" class="validate" v-model="name">
            </div>
        </div>
        <div class="row">
            <div class="input-field">
                <label class="active" >Farbe </label>
                <input type="number" placeholder="-" class="validate" v-model="grade">
            </div>
        </div>
        <div>
